...
// Enter the ottery (paying some amount)
// Pick a random winner (cerifiably random)
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    *   They look for the `upKeppNeeded` to return true.
        The following should be true in order to return true
        1. Our time itnerval should have passed
        2. The lottery should have at least 1 player, and have some ETH
        3. The  lottery in an OPEN state
    */
